    ...
    <div class="breadcurms">
     ...
     <div class="pull-left">
      ...
      <?php if($_SESSION['Role'] == "Super Admin"){ ?>
       ...
       | <a href="Vendor_forms.php?filter=admin" class="btn btn-xs btn-primary" >Vendors Details</a>
       | <a href="support_staff.php?filter=admin">Staff Details</a>
     <?php } ?>
   </div>
...
<?php
  ...
  $sql = ( "SELECT * FROM vendors_expenses  where status='Active' ORDER BY  `id` DESC");
...
echo( '<td><a href="vendor_form_update.php?id='.$row['id' ].'" class="btn btn-xs btn-primary employee-details-update">Update</a>
   <a onclick="" href="vendor_form_save.php?delete=1&id='.$row['id' ].'" class="btn btn-xs btn-danger employee-details-update">Delete</a></td>' );
...
<div class="modal fade" id="AddFreeTrail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <div class="modal-dialog  modal-lg" role="document">
   ...
   <form action="vendor_form_save.php" method="post" enctype="multipart/form-data">
     <!--<form>-->
      ...
      <div class="modal-content">
       ...
       <div class="modal-header">
        ...
        <h4 class="modal-title" id="AddFreeTrailLabel">Add New Vendor</h4>
      ...
      <div class="modal-body">
       ...
       <div class="col-sm-3">
        ...
        <div class="form-group">
         ...
         <label for="Full Name">Beneficiary Name:</label>
...
<div class="col-sm-3">
  ...
  <div class="form-group">
   ...
   <select class="form-control" name="category" required>
    ...
    <option value="House Landlord">House Landlord</option>
    <option value="True Caller">True Caller</option>
