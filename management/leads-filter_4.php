...
aa.open("GET","leads-filter-back_4.php?StartDateUSA="+StartDateUSA+"&EndtDateUSA="+EndtDateUSA+"&disposition="+disposition+"&username="+username+"&limit="+limit,true);

aa.send();
//alert(StartDateUSA + EndtDateUSA + username + disposition + limit)
