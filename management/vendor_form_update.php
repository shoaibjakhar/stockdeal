...
<?php include('connection/dbconnection_crm.php')?>
  ...
  <?php 
    ...
    if ($_GET['id']) {
      ...
      $sql = "SELECT * FROM vendors_expenses WHERE id=".$_GET['id'];
...
<div class="col-sm-3">
  ...
  <div class="form-group">
   ...
   <select class="form-control" name="category" required>
    ...
    <option value="Sim Card" <?php echo ($vendor_data['category'] == "Sim Card") ? 'selected' :'' ?>>Sim Card</option>
    <option value="Development" <?php echo ($vendor_data['category'] == "Development") ? 'selected' :'' ?>>Development</option>
    <option value="House Landlord" <?php echo ($vendor_data['category'] == "House Landlord") ? 'selected' :'' ?>>House Keeping</option>
    <option value="True Caller" <?php echo ($vendor_data['category'] == "True Caller") ? 'selected' :'' ?>>True Caller</option>
...
<div class="form-group">
  <p id="IFSC_Code_Error"></p>
   ...
   <div class="col-sm-3">
     <div class="form-group">
      <label for="Last Working Date"></label>
