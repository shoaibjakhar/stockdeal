...
<body>
  ...
  <div class="main_container">
    ...
    <div class="breadcurms"> 
      <a href="tl-leads-analytic.php" style="margin-left: -5px;" class="">Analytics Reports</a> <!-- | <a href="analytics-date.php?filter=leads-count">Leads Count</a> | <a href="export-leads.php">Export Leads</a> | <a href="whatsapp-number-update.php" class="">Whatsapp Number Update</a> | <a href="ip-restriction-history.php" class="">Ip Restriction</a> | <a href="leads-count.php" class="btn btn-xs btn-primary">Assigned Leads Analytics</a>  | <a href="upload-leads.php">Upload Leads</a> -->      
    </div>
                ...
                <div class="col-sm-12" style="display:;">
                  ...
                  <div class="panel panel-default" style="">
                        ...
                        <form class="form-inline" action="#" method="GET">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control ML10" name="UserName" required>
                              ...
                              <?php include('partial/team-leader-agents.php') ?>
                              <?php 
                          ...
                          <a href="tl-leads-analytic.php" class="btn btn-default  ML10" style="margin-left:20px;">Reset</a>
                        </form>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-4" style="display:;">
                      ...
                      <div class="panel panel-default" style="">
                        <div class="panel-heading font-size16">Leads Assigned Agents </div>
                        <div class="panel-body">
