...
<div class="breadcurms">
 <div class="pull-left">
  <a href="memberpage.php">Dashbord</a> | <a href="stock-tips.php">Stock Tips</a> | <a href="stock-tips-filter_3.php">Filter 3</a>  | <a href="stock-tips-filter_4.php">Filter 4</a> | <a href="stock-tips-update.php">Today's Update</a> | <a href="stock-tips-update-3month.php">Last 3 Months's Update</a>  | <a href="stock-tips-update-open.php"  class="btn btn-xs btn-primary">Open</a>
 </div>
...
<?php
$sql = ("SELECT Id, Ideas, Sagment, Result, DATE_FORMAT( DateTime,  '%d-%m-%Y %H : %i %p' ) AS DateTimeCurrent FROM stock_tips where Result ='open' ORDER BY `stock_tips`.`DateTime` DESC LIMIT 0 , 3000");
...
echo('<tr>');
  ...
  echo('<td><p class="Ideas" style=" width:360px; ">'.$row['Ideas'].'</p></td>');
...
<form action="stock-tips-update-open-back.php" method="get" style="display:none">
...
aa.open("GET","stock-tips-update-open-back.php?StartDate="+StartDate+"&EndtDate="+EndtDate+"&Packages="+Packages,true);
