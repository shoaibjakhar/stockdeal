...
if($_POST){
   ...
   $attd = mysql_fetch_assoc($attd_qry);
...
$Halfday_Hour = $get_hours_data['Halfday_Hour'];
  ...
  // echo $row['Agent_Name'];
   if($id == ''){
       ...
       $ins = "INSERT INTO attendence (user_id,Agent_Name,manually_added_time,date,Pl_Upl) VALUES('".$user_id."','".$row['username']."','".$extra_time."','".$date."','".$Pl_Upl."') ";
      
   }
   else if($mark == 'rejected'){
         $up_query = "UPDATE attendence SET reg_status = 'rejected', Pl_Upl = NULL WHERE id = '".$id."'";
    ...
    if($mark == 'half_day'){
     ...
     //  }
      ...
      $ins = "UPDATE attendence SET reg_status = '".$reg_status."', manually_added_time = '".$final_extra_time."', Pl_Upl = '".$Pl_Upl."' where id = '".$id."' and date = '".$date."' ";
