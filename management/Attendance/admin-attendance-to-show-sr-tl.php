...
?>
  ...
  <div class="panel-heading font-size16">
        ...
        Monthly Attendance &nbsp;&nbsp;|&nbsp;&nbsp;<a href='attendance.php?holiday_list=holiday'>Holydays List</a> &nbsp;&nbsp;|&nbsp;&nbsp;
         <a href='attendance.php'>Team Lead Attendace</a>
         &nbsp;&nbsp;|&nbsp;&nbsp;
         <!--  &nbsp;&nbsp;|&nbsp;&nbsp;
       ...
       <table id="Admin_Attendance" class="display nowrap table table-bordered table-hover-attendance" style="width:100%">
        ...
        <tbody>
            ...
            if($_SESSION['Role'] == 'SR_TL'){
                 $qry_agents = "SELECT Id, username,Date_of_Join from employee where Team_Leader = '".$username."' AND Status = 'Active' AND Role='Team Leader' AND username !='Akshay Shetty' AND username !='Select'";
            }
            else{
