...
if($_SESSION['Role'] == 'Team Leader') {
 echo('<div class="breadcurms"><a href="memberpage.php">Dashbord</a> | <a href="website-leads-rsi.php">Single Assign</a> | <a href="assign-multiple-leads.php">Multiple Assign</a> | <a href="assign-leads-new-front.php">Bulk Assign</a> | <a href="leads-filter_4_new.php" class="btn btn-xs btn-primary">Re Assign</a> | <a href="leads-count.php">Analytics</a></div>');
}
?>
...
$sql = ("SELECT Id, Full_Name, Email, Mobile, Disposition, Source, UserName, Date, DateTime, TimeStamp, ModalFowllowUpDateTime FROM Assigned_Leads WHERE (DateTime >= '".$StartDateUSA."') AND (DateTime <= '".$EndtDateUSA."') && `username` ='".$usernames."' && `Disposition` ='".$disposition."' ORDER BY  `Assigned_Leads`.`Id` DESC  LIMIT 0,  $limit" );
...
echo "<form name='form_update' method='post' action='re-assign-back.php'>\n";
