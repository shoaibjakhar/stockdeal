...
<div class="breadcurms">
 <div class="pull-left">
<a href="memberpage.php">Dashbord</a> | <a href="demo-stock-tips.php">Demo Stock Tips</a> | <a href="demo-stock-tips-update">Demo Today's Update</a> | <a href="demo-stock-tips-update-3month.php">Demo Last 3 Months's Update</a> | <a href="demo-stock-tips-update-open.php" class="btn btn-xs btn-primary">Demo Open</a> 
 </div>
...
<?php
$sql = ("SELECT Id, Ideas, Sagment, Result, DATE_FORMAT( DateTime,  '%d-%m-%Y %H : %i %p' ) AS DateTimeCurrent FROM Demo_Stock_Tips where Result ='open' ORDER BY `Demo_Stock_Tips`.`DateTime` DESC LIMIT 0 , 3000");
...
echo('<tr>');
  ...
  echo('<td><p class="Ideas" style=" width:360px; height:80px;">'.$row['Ideas'].'</p></td>');
...
<form action="demo-stock-tips-update-open-back.php" method="get" style="display:none">
...
aa.open("GET","demo-stock-tips-update-open-back.php?StartDate="+StartDate+"&EndtDate="+EndtDate+"&Packages="+Packages,true);
