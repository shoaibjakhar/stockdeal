...
<div class="breadcurms">
 <div class="pull-left">
  <a href="memberpage.php">Dashbord</a> | <a href="demo-stock-tips.php">Demo Stock Tips</a> | <a href="demo-stock-tips-update.php">Demo Today's Update</a> | <a href="demo-stock-tips-update-3month.php" class="btn btn-xs btn-primary">Demo Last 3 Months's Update</a> | <a href="demo-stock-tips-update-open.php">Demo Open</a>
 </div>
...
<?php
$sql = ("SELECT Id, Ideas, Sagment, Result, DATE_FORMAT( DateTime,  '%d-%m-%Y %H : %i %p' ) AS DateTimeCurrent FROM Demo_Stock_Tips ORDER BY `Demo_Stock_Tips`.`DateTime` DESC LIMIT 0 , 3000");
