...
<div class="main_container">
 ...
 <div class="clearfix"></div>
  ...
  <div class="containter" style="padding:15px 20px 0 25px;">
   <?php include('connection/dbconnection_crm.php')?>
   
  <form class="form-inline" method="get" action="stock-tips-download-back.php">
  
	   <div class="form-group">
    <input type="text" class="form-control" value="" id="StartDate" placeholder="Start Date" autocomplete="off" required>
    <input type="hidden" value="" id="StartDateUSA" name="StartDateUSA">
  </div>
   <div class="form-group">
    <input type="text" value=""  class="form-control" id="EndtDate" placeholder="End Date" autocomplete="off" required>
