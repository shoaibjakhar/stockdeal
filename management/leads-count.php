            ...
            <div class="panel-heading font-size16">
              ...
              <div class="panel-body">
                ...
                <div class="col-sm-12" style="display:;">
                  ...
                  <div class="panel panel-default" style="">
                       ...
                       <div class="col-sm-12 ML20 MB20" style="padding: 25px 15px;">
                        <form class="form-inline" action="#" method="GET">
                          ...
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control ML10"  id="dates" name="to"  value="<?php echo isset($_GET['to'])?$_GET['to']:date('Y-m-d');?>" required="">
                          </div>
                          <div class="form-group">
                          ...
                          <a href="leads-count.php" class="btn btn-default  ML10" style="margin-left:20px;">Reset</a>
                        </form>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-4" style="display:;">
                      ...
                      <div class="panel panel-default" style="">
                        <div class="panel-heading font-size16">Category Wise</div>
                        <div class="panel-body">
                          ...
                          <table width="100%" class="table table-bordered" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <th colspan=""><strong>
                                  <?php 
                                     $result = mysqli_query($connect, "SELECT COUNT(*) as total FROM Assigned_Leads GROUP BY Source");
                      ...
                      <div class="panel panel-default" style="">
                        <div class="panel-heading font-size16">Agent Names </div>
                        <div class="panel-body">

                          <table width="100%" class="table table-bordered" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                              <tr>
                                <td><strong>Agent Names</strong></td>
                                <td><strong>Count</strong></td>
                              ...
                              <tr>
                                ...
                                <th colspan=""><strong>
                                  <?php 
                                     $result = mysqli_query($connect, "SELECT COUNT(*) as total FROM Assigned_Leads GROUP BY UserName");
                                     //echo mysql_result($result, 0);
                                      $rowcount=mysqli_num_rows($result);
                                      echo $rowcount;
                                  ?>
                      ...
                      <div class="panel panel-default" style="">
                        ...
                        <div class="panel-body">
                          ...
                          <tr class="Total">
                            ...
                            <tbody>
                              <tr class="yellow-bg">
                                ...
                                <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Busy tone&amp;source=">
                                  <?php
                                  $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'B')");
                                    $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                  ?>
                                </a></td>
                              ...
                              <tr class="green-bg">
                                ...
                                <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Paid Customer&amp;source=">
                                  <?php
                                  $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'PC')");
                                    $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                  ?>
                                </a></td>
                              ...
                              <tr class="yellow-bg">
                                ...
                                <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Hung Up&amp;source=">
                                  <?php
                                  $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'HU')");
                                    $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                  ?>
                                </a></td>
                              ...
                              <tr class="green-bg">
                                ...
                                <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Sale&amp;source=">
                                  <?php
                                  $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'Sale')");
                                    $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                  ?>
                                </a></td>
                              ...
                              <tr class="white-bg">
                                ...
                                <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Fresh&amp;source=">
                                  <?php
                                  $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total  FROM Assigned_Leads WHERE (Disposition =  'Fresh')");
                                  $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                  ?>
                              ...
                              <tr class="red-bg">
                                ...
                                <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Wrong Number&amp;source=">
                                  <?php
                                  $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'WN')");
                                    $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                  ?>
                                </a></td>
                              ...
                              <tr class="yellow-bg">
                                ...
                                <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Duplicate&amp;source=">
                                  <?php
                                  $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'Duplicate')");
                                    $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                  ?>
                                </a></td>
                              ...
                              <tr class="red-bg">
                                ...
                                <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Do Not Disturb&amp;source=">
                                  <?php
                                  $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'DND')");
                                    $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                  ?>
                                </a></td>
                              ...
                              <tr class="red-bg">
                                ...
                                <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Not Contactable&amp;source=">
                                  <?php
                                  $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'NT')");
                                    $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                  ?>
                                </a></td>
                              ...
                              <tr class="red-bg">
                                ...
                                <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Language Barrier&amp;source=">
                                  <?php
                                  $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'LB')");
                                    $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                  ?>
                                </a></td>
                              ...
                              <tr class="red-bg">
                                ...
                                <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Commodity Trader&amp;source=">
                                  <?php
                                  $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'CT')");
                                    $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                  ?>
                                </a></td>
                              ...
                              <tr class="red-bg">
                                ...
                                <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=NI - Others&amp;source=">
                                 <?php
                                 $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'NI - Others')");
                                   $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                 ?>
                             ...
                             <tr class="red-bg">
                              ...
                              <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=NI - Do not want to trade now&amp;source=">
                                <?php
                                $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'NI - Do not want to trade now')");
                                  $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                ?>
                            ...
                            <tr class="red-bg">
                              ...
                              <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=NI - losses/No risk taker&amp;source=">
                                <?php
                                $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'NI - losses/No risk taker')");
                                  $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                                ?>
                              </a></td>
                            ...
                            <tr class="yellow-bg">
                              ...
                              <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=NI - less funds/low budget&amp;source=">
                               <?php
                               $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'NI - less funds/low budget')");
                                 $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                               ?>
                             </a></td>
                           ...
                           <tr class="yellow-bg">
                            ...
                            <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Switched Off&amp;source=">
                              <?php
                              $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'SW')");
                                $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                              ?>
                            </a></td>
                          ...
                          <tr class="yellow-bg">
                            ...
                            <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Ringing&amp;source=">
                              <?php
                              $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'R')");
                                $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                              ?>
                            </a></td>
                          ...
                          <tr class="yellow-bg">
                            ...
                            <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Promise To Pay Online&amp;source=">
                              <?php
                              $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'PTPO')");
                                $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                              ?>
                            </a></td>
                          ...
                          <tr class="yellow-bg">
                            ...
                            <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Call Back Without Presentation&amp;source=">
                              <?php
                              $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'CBWOP')");
                                $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                              ?>
                            </a></td>
                          ...
                          <tr class="yellow-bg">
                            ...
                            <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Call Back With Presentation&amp;source=">
                              <?php
                              $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'CBWP')");
                                $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                              ?>
                            </a>
                          ...
                          <tr class="yellow-bg">
                            ...
                            <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=PTPC&amp;source=">
                              <?php
                              $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'PTPC')");
                                $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                              ?>
                            </a>
                           ...
                           <tr class="yellow-bg">
                            ...
                            <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=FT&amp;source=">
                              <?php
                              $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'FT')");
                                $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                              ?>
                            </a>
                           ...
                           <tr class="yellow-bg">
                            ...
                            <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=NR&amp;source=">
                              <?php
                              $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'NR')");
                                $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                              ?>
                            </a>
                           ...
                           <tr class="yellow-bg">
                            ...
                            <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=FTN&amp;source=">
                              <?php
                              $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'FTN')");
                                $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                              ?>
                            </a>
                           ...
                           <tr class="yellow-bg">
                            ...
                            <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=NCD&amp;source=">
                              <?php
                              $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'NCD')");
                                $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                              ?>
                            </a>
                           ...
                           <tr class="yellow-bg">
                            ...
                            <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=NI&amp;source=">
                              <?php
                              $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'NI')");
                                $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                              ?>
                            </a>
                           ...
                           <tr class="yellow-bg">
                            ...
                            <td><a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=Demat Account Inquiry&amp;source=">
                              <?php
                              $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads WHERE (Disposition =  'Demat Account Inquiry')");
                                $fetch = $result->fetch_assoc();
                                  echo $fetch['total'];
                              ?>
                            </a>
                          ...
                          <tr class="Total">
                            ...
                            <td>
                              <a href="leads-count-details.php?agent_name=&amp;from=&amp;to=&amp;disposition=total&amp;source=">
                               <?php
                               $result = mysqli_query($connect, "SELECT COUNT( Disposition ) as total FROM Assigned_Leads");
                                 $fetch = $result->fetch_assoc();
                                  $count = $fetch['total'];
                                  echo $fetch['total'];
                               ?>
               ...
               <?php
                  ...
                  $sql1 ="SELECT Source, count(*) as NUM FROM Assigned_Leads GROUP BY Source";
