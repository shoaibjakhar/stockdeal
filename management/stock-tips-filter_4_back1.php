...
$Packageresults = $_GET['Packageresults'];
//$limit = $_GET['limit'];

//echo($StartDateUSA.' '.$EndtDateUSA.' '.$Packages.' '.$Packageresults ); 
...
<?php include('connection/dbconnection_crm.php') ?>
	...
	$sql = ("SELECT Id, Ideas, Sagment, Result, DATE_FORMAT( DateTime,  '%d-%m-%Y %H:%i' ) AS DateTimeCurrent FROM stock_tips WHERE Date >= '".$StartDateUSA."' AND Date <= '".$EndtDateUSA."' && `Sagment` ='".$Packageresults."' && `Result` ='".$Packageresults."' limit 30");
