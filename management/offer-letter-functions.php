...
include_once 'user-agreement/PHPMailer-master/PHPMailerAutoload.php';
$mail = new PHPMailer(true);

          // $mail->SMTPDebug = 3;
        $mail->IsSMTP();                                      // Set mailer to use SMTP
        //$mail->Host = "shareidea.co.in";        ca         // Specify main and backup server
        $mail->Host = 'smtp.gmail.com';           //aa
        //$mail->Host = "Give IP Address";                 // If the above does not work.
        //$mail->Port = 25;                      ca              // Set the SMTP port
        $mail->Port = '587'; 
        ...
        // $senderEmail = "sale@shareidea.co.in";                                 // TCP port to connect to
        ...
        //$mail->setFrom($senderEmail, $senderName);
         ...
         $mail->AddCC("sale@stockdeal.co.in");
          ...
          $mail->Subject = 'Stock Deal: Offer Letter!';
