...
<div class="main_container">
  ...
  <div class="breadcurms"> <a href="view-leads.php">View Leads</a> | <a href="lead-details.php" >Lead details</a> | <a href="lead-details-filter1.php">Filter 1</a></div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><select id="Disposition_Modal" class="form-control">
                ...
                <td><input type="text" class="form-control disableNow" id="datepicker" placeholder="Date">
       ...
       <select id="Second">
          ...
          <?php require('partial/seconds.php'); ?> 
             ...
             <td><input type="text" class="form-control" id="Modal_State"/></td>
              ...
              <td><input type="text" id="Modal_UserName"value="<?php  echo $_SESSION['username'];?>" class="form-control"/></td>
...
//alert(Id_modal+DateTimeModel+Disposition_Modal )


//return false;
aa.open("GET","disposition-update.php?Id_modal="+Id_modal+"&DateTimeModel="+DateTimeModel+"&Disposition_Modal="+Disposition_Modal,true);
aa.send();
}
...
aa.send();
 ...
 $('#SaveChanges').click(function() {
  ...
  $("#Disposition_Modal").on('change', function() {
	 ...
	 if(disableNow == 'NT' || disableNow == 'NI' || disableNow == 'CT' || disableNow == 'LB' || disableNow == 'DND' || disableNow == 'R' || disableNow == 'WN' || disableNow == 'DC' || disableNow == 'NR' || disableNow == 'SW') {
