        ...
        <div class="row">
            <div class="col-sm-12" style="visibility:">  
                <div class="panel panel-primary">
                  <div class="panel-heading font-size18">Management Working Status</div>
                  <div class="panel-body" style="">
                    <table class="table table-bordered" id="management_working_status">
                        <thead>
                            <tr>
                              <th>Leader Name</th>
                              <th>Role</th>
                      ...
                      <tbody>
                                   ...
                                   // SELECT attendence.*,'employee.Status' AS 'login_status' FROM 'attendence' JOIN 'employee' ON 'attendence.user_id' = 'employee.id' WHERE 'attendence.date' = '19-10-2022';
                                    ...
                                    $sql="SELECT attendence.*, employee.Role,employee.login_status ,employee.username FROM attendence JOIN employee ON attendence.user_id=employee.id WHERE attendence.date='$current_date' AND employee.Role='Team Leader'";
...
<script>
 $('#management_working_status').DataTable();
</script>