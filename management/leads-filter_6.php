...
<form class="form-inline">
  ...
  -->
  <div class="form-group pull-left">
    <select id="username"  style="margin-left:10px;width:160px;" class="form-control">
     <?php include('partial/agents.php') ?>
</select>
  </div>
  
  <div class="form-group pull-left">
    <select id="disposition"   style="width:120px;margin-left:10px;"  class="form-control">
     <?php include('partial/disposition.php') ?>
</select>
  </div>
  
  <div class="form-group pull-left">
    <select id="source_name"  style="margin-left:10px;width:120px;"  class="form-control">
     <?php include('partial/source_name.php') ?>
</select>
  </div>
  
   <div class="form-group pull-left">
    <input type="text" value="10" style="width:80px;margin-left:10px;" class="form-control" id="limit">
...
aa.open("GET","leads-filter-back_6.php?StartDateUSA="+StartDateUSA+"&EndtDateUSA="+EndtDateUSA+"&disposition="+disposition+"&source_name="+source_name+"&username="+username+"&limit="+limit,true);

aa.send();
//alert(StartDateUSA + EndtDateUSA + username + disposition + source_name +  limit)
