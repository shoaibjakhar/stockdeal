...
<form class="form-inline">
 ...
 -->
  ...
  <div class="form-group pull-left">
   ...
   <div class="form-group pull-left">
    <input type="text" value="6" style="width:80px;margin-left:10px;" class="form-control" id="limit">
...
aa.open("GET","leads-filter-back_7.php?disposition="+disposition+"&source_name="+source_name+"&username="+username+"&limit="+limit,true);

aa.send();
//alert(username + disposition + source_name +  limit)
//alert('aaaa');
}
</script>
