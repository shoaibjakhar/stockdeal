...
<body>
 ...
 <div class="breadcurms">
   ...
   <div class="pull-left">
    ...
    <a href="agent-advance-payment-details.php" class="btn btn-xs btn-primary">Agent Advance Payment</a> | 
    <a href="team-lead-advance-payment-details.php" >Team Lead Advance Payment</a> |
    <a href="agent-bonus-details.php" >Agent Bonus Details</a> 
...
<div class="containter" style="padding:20px 20px 0 20px;">
  ...
  $sql="SELECT Advance_salary.*, employee.username
        FROM Advance_salary
        INNER JOIN employee ON Advance_salary.employee_id=employee.id WHERE employee.Role='Agent' ORDER BY Advance_salary.id DESC";
        $result = mysqli_query($connect, $sql );


   $sql1 = "SELECT * FROM employee  where  Role='Agent' AND Status='Active' ORDER BY  `id` DESC LIMIT 0 , 1000";
  ...
  <table id="agent_payment" class="display" style="text-align: center;">
    <thead>
      <tr>
