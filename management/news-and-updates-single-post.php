...
<title>News and Updates Single Post</title>
...
<div class="breadcurms">
 <div class="pull-left">
  <a href="memberpage.php">Dashbord</a> | <a href="news-and-updates.php" class="btn btn-xs btn-primary">News and Updates </a>  | <a href="quality-analysis.php" class="">Quality &amp; Compliance</a> | <a href="quality-analysis-others.php"> Others</a>
 </div>
...
//}  ?>
      ...
      <div class="panel-body">
		 ...
		 <div>
			    ...
			    if($get_pre_id){
			    ?>
			  	<!--  <a href="news-and-updates-single-post.php?post_id=<?php echo $get_pre_id['Id']; ?>" class="pull-left btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i> Previous</a>  -->
			    <?php
			    }
			    if($get_next_id){
			    
			    ?>
			<!--	<a href="news-and-updates-single-post.php?post_id=<?php echo $get_next_id['Id']; ?>" class="pull-left btn btn-primary ML20">Next <i class="fa fa-arrow-right" aria-hidden="true"></i></a> -->
				<?php
			    }
				?>
				</div>
	    ...
	    if($qry_post['User_View']){
        	  ...
        	  // $user_view = array_combine(range(1, count($user_view)), array_values($user_view));
        	   ...
        	   if(array_search($_SESSION['Id'],$user_view)){
        	      ...
        	      //echo "Not Found";
        	      $user_view[$total_news_count+1] = $_SESSION['Id'];
