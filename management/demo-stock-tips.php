...
<div class="breadcurms">
 <div class="pull-left">
<a href="memberpage.php">Dashbord</a> | <a href="demo-stock-tips.php" class="btn btn-xs btn-primary">Demo Stock Tips</a> | <a href="demo-stock-tips-update.php">Demo Today's Update</a> | <a href="demo-stock-tips-update-3month.php">Demo Last 3 Months's Update</a> | <a href="demo-stock-tips-update-open.php">Demo Open</a>
 </div>
...
<?php
$sql = ("SELECT Id, Ideas, Sagment, Result, DATE_FORMAT( DateTime,  '%d-%m-%Y %H : %i' ) AS DateTimeCurrent FROM Demo_Stock_Tips WHERE DATE( CURDATE( ) ) = DATE( DateTime) ORDER BY `Demo_Stock_Tips`.`DateTime` DESC");
//echo $sql;exit; 
...
<form action="demo-stock-tips-delete.php" method="get" style="display:none">
...
var request = $.ajax({
  url: "demo-stock-tips-add.php?v=<?php echo time(); ?>",
  type: "POST",
