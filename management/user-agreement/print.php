...
<body>
    ...
    <div class="container">
      ...
      <a class="navbar-brand" href="https://sharebazarexpert.com/"><img src="https://sharebazarexpert.com/wp-content/uploads/2022/01/SHARE-BAZAR-EXPERT-LOGO-1.png" width="236px !important" height="41px !important"></a>
      

      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" href="https://sharebazarexpert.com/">Home</a>
        </li>
      </ul>
    </div>
    </nav>
...
<div class="container pt-5">
  ...
  <p class="lead"><strong>We have sent</strong> agreement copy to your email address.</p>
  <p class="lead">Thanking You,
           <br> Share Bazar Expert Team</p>
  <hr>
  <p>
  ...
  <form action="upload.php"  method="post">
    <label style="font-size: 20px;"><span style="font-weight: 600">Full Name: </span> <?php echo $full_name;?></label>
    <br>
    <label style="font-size: 20px;"><span style="font-weight: 600">Mobile: </span> <?php echo $mobile;?></label>
    <br>
    <label style="font-size: 20px;"><span style="font-weight: 600">Email: </span><?php echo $email;?></label>
    <br>
    <label style="font-size: 20px;"><span style="font-weight: 600">Agent Name: </span><?php echo $agent_name;?></label>
    <br>
    <label style="font-size: 20px;" class="" for=""><span style="font-weight: 600">Customer Signature: </span></label>
    <img src="<?php echo $file; ?>" alt="Signature image">
  </form>
