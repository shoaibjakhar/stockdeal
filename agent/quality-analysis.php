...
<div class="main_container">
  ...
  <div class="breadcurms"> <?php if($_SESSION['Role'] != 'Customer Care'){ ?><a href="news-and-updates.php">News and Updates</a> |<?php } ?> <a href="quality-analysis.php"  class="btn btn-xs btn-primary">Quality & Compliance</a> | <a href="quality-analysis-others.php"> Others</a>
   | 
  <a onclick="return confirmation()" href="offer-letter-functions.php?Id=<?php echo $_SESSION["Id"]?>" class="btn btn-sm"><i class="fa fa-send"></i> Request For Offer Letter</a> </div>
