...
$index_data = getAll('index','order by id desc');
    ...
    <div class="container">
        <ul class="tab1">
            ...
            <a href="index.php" target="_self">
                <li class="active" id="tab8">Index</li>
            </a>
        </ul>
    </div>
    ...
    <div class="container">
        ...
        <table class="table table-bordered" style="margin-top:20px; ">
            <tr style="font-weight: 900">
                ...
                <td>Profit Loss</td>
                <td>Class</td>
                <td><a href="#" class="btn btn-success" data-toggle="modal" data-target="#exampleModalCenter">Add Index</a> </td>
            </tr>
            ...
            <tr>
                ...
                <td><a href="delete_index.php?id=<?php echo $value['id']; ?>" class="btn btn-danger">Delete</a></td>
            </tr>
            <?php
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalCenterTitle">Add Index</h3>
                    ...
                    <form action="" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Date aa</label>
  ...
  <script>
      $(document).ready(()=>{
          $(".update_data").click((e)=>{
              ...
              $("#update_body").load('edit_index.php?id='+id);
          })
      })
  </script>  
