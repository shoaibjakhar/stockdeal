...
$Future_Intraday_data = getAll('Equity_Intraday','order by id desc');
...
if($_POST){
    ...
    $ins = insert('Equity_Intraday',$data);
    ...
    <div class="container">
        <ul class="tab1">
            <a href="equity-intraday.php" target="_self">
                <li class="active" id="tab1">Equity Intraday</li>
            </a>
    ...
    <div class="container">
        ...
        <table class="table table-bordered" style="margin-top:20px; ">
            <tr style="font-weight: 900">
                ...
                <td>Profit Loss</td>
                <td>Class</td>
                <td><a href="#" class="btn btn-success" data-toggle="modal" data-target="#exampleModalCenter">Add Equity Intraday</a> </td>
            </tr>
            ...
            <tr>
                ...
                <td><a href="delete_equity-intraday.php?id=<?php echo $value['id']; ?>" class="btn btn-danger">Delete</a></td>
            </tr>
            <?php
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalCenterTitle">Add Equity Intraday</h3>
