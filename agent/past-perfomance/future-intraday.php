...
$Future_Intraday_data = getAll('Future_Intraday','order by id desc');
...
if($_POST){
    ...
    $ins = insert('Future_Intraday',$data);
    ...
    <div class="container">
        <ul class="tab1">
            ...
            <a href="future-intraday.php" target="_self">
                <li class="active" id="tab3" class="">Future Intraday</li>
            </a>
            <a href="stock-options.php" target="_self">
                <li  id="tab4">Stock Options</li>
            </a>
    ...
    <div class="container">
        ...
        <table class="table table-bordered" style="margin-top:20px; ">
            <tr style="font-weight: 900">
                ...
                <td>Profit Loss</td>
                <td>Class</td>
                <td><a href="#" class="btn btn-success" data-toggle="modal" data-target="#exampleModalCenter">Add Future Intraday</a> </td>
            </tr>

            <?php

                if($Future_Intraday_data){
                    foreach ($Future_Intraday_data as $key => $value) {
            ...
            <tr>
                ...
                <td><a href="delete_future-intraday.php?id=<?php echo $value['id']; ?>" class="btn btn-danger">Delete</a></td>
            </tr>
            <?php
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalCenterTitle">Add Future Intraday</h3>
