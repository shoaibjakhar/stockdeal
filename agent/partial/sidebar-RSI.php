...
//include_once('connection/dbconnection_crm.php');
	...
	//<span class="request-notification">'.$not_seen.'</span>
        $sel = "select count(*) as cn FROM `Assigned_Leads` WHERE Disposition='Fresh' and UserName ='$name' and (Source='LEADSFB' or Source='Website' or Source='Direct')";
...
<!-- <li><a href="view-leads.php"><img src="images/lead.png" alt=""/>&nbsp;&nbsp;View Lead <span class="badge badge-pill badge-info request-notification"><?php //echo $fetch['cn'];?></span></a></li> -->
<li><a href="quality-analysis.php"><img src="images/quaility.png" alt=""/>&nbsp;&nbsp;Quality &amp; Compliance</a></li>
<li><a href="risk-profile.php"><img src="images/lock-24.png" alt=""/>&nbsp;&nbsp;Risk Profile</a></li>
<li><a href="agreement.php"><img src="images/lock-24.png" alt=""/>&nbsp;&nbsp;Agreement</a></li>
...
<li><a href="#_"><img src="images/globe.png" alt=""/>&nbsp;&nbsp;Test</a></li>-->
	...
	<?php
		...
		?>
			<li>
			    <a href="lead-details-filter2-new.php">Filter 1</a>
			</li>	
			<li>
			    <a href="dashboard.php">Dashboard</a>
			</li>
			<li>
			    <a href="follow-up-leads-filter-2.php">Filter 2</a>
			</li>
			<li><a href="stock-tips.php"><img src="images/research.png" alt=""/>&nbsp;&nbsp;Stock Tips</a></li>
			<li><a href="quality-analysis.php"><img src="images/quaility.png" alt=""/>&nbsp;&nbsp;Quality &amp; Compliance</a></li>
		    <li><a href="agent-request-received.php"><img src="images/send-email.png" alt=""/>&nbsp;&nbsp;Request <span class="badge badge-pill badge-info request-notification"><?php echo $data['total'];?></span></a></li>
