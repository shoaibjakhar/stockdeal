        ...
        <table width="100%"  border="0" class="table table-bordered" cellspacing="0" cellpadding="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><input type="text" value="<?php echo $fetch_data['Paid_Amout']; ?>" id="TotalReceivedAmount_Update" name="TotalReceivedAmount" class="form-control" placeholder="Total Received Amount" required/></td>
            ...
            <tr>
              ...
              <td><input type="text" value="<?php  echo $fetch_data['Company_Amount'];?>" id="Company_Amounts_Update" name="Company_Amount" class="form-control" placeholder="Paid Amout" required/></td>

              <td><input type="text" value="<?php  echo $fetch_data['Tax_Amount'];?>" id="TAX_Amount_Update" name="TAX_Amount" class="form-control" placeholder="TAX Amount" required/></td>
