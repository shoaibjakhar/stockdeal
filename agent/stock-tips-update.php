...
<div class="breadcurms">
 <div class="pull-left">
  <a href="memberpage.php">Dashbord</a> | <a href="stock-tips.php">Stock Tips</a> | <a href="stock-tips-filter.php">Filter 3</a>  | <a href="stock-tips-filter_2.php">Filter 4</a> | <a href="stock-tips-update" class="btn btn-xs btn-primary">Today's Update</a> | <a href="stock-tips-update-3month.php">Last 3 Months's Update</a> | <a href="stock-tips-update-open.php">Open</a> 
 </div>
...
echo('<tr>');
  ...
  echo('<td><div class="btn text-center '.$row['Result'].'" style="margin-top:10px;margin-bottom:10px;margin-left:10px">'.$row['Result'].'</div></td>');
