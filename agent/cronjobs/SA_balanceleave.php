<?php
include_once($_SERVER['DOCUMENT_ROOT']."/connection/dbconnection_crm_SA.php");
...
if(count($names)>0){
    ...
    $to = "info@shareadvisor.in";
    $subject = "Paid Leaves Cron Job Processed for Share Advisor";
    ...
    // More headers
    $headers .= 'From: <admin@shareadvisor.in>' . "\r\n";
