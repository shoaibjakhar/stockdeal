			  ...
			  <div class="row">
				  ...
				  <div class="col-sm-3" style="display: none;">
				   <label for="">Pan Number</label>
					  <input type="text" value="" id="PanNumber" name="PanNumber"  class="form-control uppercase" placeholder="Pan Number" maxlength="10"/>
				  </div>
				  <?php
				    }
				  ?>
				  ...
				  ?>
				    <div class="col-sm-3" style="display: none;">
				   <label for="">KYC</label>
					  <select class="form-control" id="KYC" name="KYC">
            ...
            <option value="Scan">Scan copy</option>
				  ...
				  ?>
				   ...
				   <label for="">Risk_Score</label>
					  <input type="text" value="" id="Risk_Score" name="Risk_Score" class="form-control" placeholder="Risk Score"/>
				  </div>
				  <?php
				    }
				  ?>
				  ...
				  <div class="col-sm-3" style="display: none;">
				   <label for="">Date of Birth *</label>
					  <input type="text" value="" id="Date_of_Birth" name="Date_of_Birth" class="form-control" placeholder="Date of Birth"  autocomplete="off" />
      ...
      <input type="hidden" value="" id="TAX_Amount" name="TAX_Amount" class="form-control" placeholder="TAX Amount" required/>
          ...
          <?php
                    ...
                    echo '<option value="">Select Agent</option>';
					   ...
					   <input type="text" placeholder="%" value="" name="Agent_3_Percentange" id="Agent_3_Percentange" class="form-control" style="width: 50px;float: left;" >
