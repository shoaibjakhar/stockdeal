...
<div class="breadcurms">
 <div class="pull-left">
<a href="dashboard.php">Dashbord</a> | <a href="customer-profile-new-3-month.php" class="btn btn-xs btn-primary">Customer details</a> | <a href="customer-profile-new-3-month-details.php">All Payment History</a>
 </div>
...
$sql = ("SELECT Costumer_ID, DATE_FORMAT( SaleDate,  '%d-%m-%Y' ) AS SaleDateIND, Full_Name,  Email_ID, Mobile_No, Pan_Number, PackageName,  DATE_FORMAT( Activation_Date,  '%d-%m-%Y' ) AS ActivationDate ,
...
Date_of_Birth, KYC, Risk_Score, Risk_Level, DATE_FORMAT( DateTime,  '%d-%m-%Y %h %i' ) AS DateTimeConvert  FROM Customer_profile WHERE (SaleDate>= DATE_FORMAT(CURDATE(),'%Y-%m-01') - INTERVAL 9 MONTH) AND (Agent_1 = '".$username."' OR Agent_2 = '".$username."' OR Agent_3 = '".$username."') ORDER BY  `DateTime` DESC ");
